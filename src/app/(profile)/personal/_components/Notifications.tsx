...
export default function Notifications() {
  ...
  const updateNotificationAPI = async (
    ...
    try {
      ...
      await notificationAPI.updateNotifications(payload);
    } catch (error) {
  ...
  return (
    <div className="Notification flex flex-col gap-8 rounded-[8px] border-[0.8px] border-[#DAD8D8] p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
      ...
      <div className="Order-Notification flex flex-col gap-4">
        ...
        <div className="switchs bg-[#F7FCFF] rounded-[12px] p-3">
          <SwitchNotification
...
const SwitchNotification = ({
  ...
  return (
    <div className="confirmation flex items-center justify-between py-5 h-16">
