...
export default function Hero() {
    return (
        <div className="relative w-full lg:h-[70vh] md:h-[50vh]">
            <Image src="/herobg.png" alt="hero" fill className="object-cover" />
            <div className="absolute inset-0 bg-[#014162F2]"></div>
            <div className="relative flex md:flex-row flex-col h-full items-start justify-between text-white">
                <div className="lg:ms-24 md:ms-16  flex flex-col items-start self-center">
